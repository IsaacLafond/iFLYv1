    ...
    return (
      <nav className="navbar">
        <div className="d-flex align-items-center">
            ...
            <a className="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover mx-5" href="/iFLYv1/reviews">Reviews</a>
